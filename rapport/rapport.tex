...
Combiner du Q-Learning avec une métaheuristique est une idée que nous avions dès le départ du projet. En faisant nos recherches, nous avons trouvé le survey de Yang et al. (\textit{Advancements in Q-learning meta-heuristic optimization algorithms: A survey}, WIREs Data Mining and Knowledge Discovery, 2024 --- \url{https://wires.onlinelibrary.wiley.com/doi/full/10.1002/widm.1548}) qui confirme que cette combinaison est étudiée depuis une vingtaine d'années, notamment pour l'adaptation de paramètres et la sélection d'opérateurs. Cela nous a confortés dans notre choix.
