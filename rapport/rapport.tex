...
En cherchant comment améliorer notre ACO, nous sommes tombés sur le survey de Yang et al. (\textit{Advancements in Q-learning meta-heuristic optimization algorithms: A survey}, WIREs Data Mining and Knowledge Discovery, 2024 --- \url{https://wires.onlinelibrary.wiley.com/doi/full/10.1002/widm.1548}) qui recense 20 ans de travaux combinant Q-Learning et métaheuristiques. On y retrouve notamment des approches d'adaptation de paramètres et de sélection d'opérateurs, ce qui correspond exactement à notre problème. C'est cette lecture qui nous a orientés vers le Q-Learning.
