...
L'idée d'utiliser l'apprentissage par renforcement pour piloter une métaheuristique n'est pas nouvelle. Le survey de Yang et al. (\textit{Advancements in Q-learning meta-heuristic optimization algorithms: A survey}, WIREs Data Mining and Knowledge Discovery, 2024 --- disponible sur \url{https://wires.onlinelibrary.wiley.com/doi/full/10.1002/widm.1548}) recense 20 ans de travaux combinant Q-Learning et métaheuristiques, notamment pour l'adaptation de paramètres et la sélection d'opérateurs. C'est ce courant de recherche qui a inspiré notre approche.
